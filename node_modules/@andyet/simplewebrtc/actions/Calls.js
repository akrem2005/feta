...
exports.updateCallState = exports.setDesiredMediaForCall = exports.resumeRecording = exports.pauseRecording = exports.endRecording = exports.startRecording = exports.resumeCall = exports.pauseCall = exports.changeCallMode = exports.leaveCall = exports.joinCall = exports.endCall = exports.startCall = void 0;
...
function leaveCall(roomAddress, endMedia) {
    return (dispatch, getState) => {
        const state = getState();
        const originalCalls = (0, Selectors_1.getJoinedCalls)(state);
        dispatch({
            payload: {
                roomAddress
            },
        ...
        const remainingCalls = (0, Selectors_1.getJoinedCalls)(updatedState);
        const client = (0, Selectors_1.getClient)(state);
        if (client) {
            client.sendRoomPresence(roomAddress);
            client.mesh.updateConnections('leave-call');
            const speaking = (0, Selectors_1.userIsSpeaking)(state);
            if (speaking) {
                client.sendAllCallsSpeakingUpdate(true);
            }
        }
        if (endMedia && originalCalls.length > 0 && remainingCalls.length === 0) {
            dispatch((0, Media_1.removeAllMedia)());
        }
    };
}
