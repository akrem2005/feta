...
exports.sendPeerCommand = exports.sendRoomCommand = exports.connectionStateChanged = exports.disableTelemetry = exports.enableTelemetry = exports.telemetrySucess = exports.sendQueuedTelemetry = exports.queueTelemetry = exports.receivedConfigError = exports.receivedConfig = exports.disconnect = exports.connect = exports.fetchConfig = exports.sleep = void 0;
...
function disconnect() {
    return (dispatch, getState) => {
        const signalingClient = (0, Selectors_1.getClient)(getState());
        if (signalingClient) {
...
function sendQueuedTelemetry() {
    return (dispatch, getState) => {
        ...
        const queuedTelemetry = (0, Selectors_1.getQueuedTelemetry)(state);
