...
export type Actions = AddMedia | RemoveMedia | MediaUpdated | SetVideoResolutionTiers;
/**
 ...
 * @param replaces
 */
export declare function addLocalAudio(track: MediaStreamTrack, stream: MediaStream, replaces?: string, monitorVolume?: boolean, name?: string): ThunkAction<void, State, void, AddMedia | RemoveMedia>;
/**
 * @description
 ...
 * @param name
 */
export declare function addLocalVideo(track: MediaStreamTrack, stream: MediaStream, mirror?: boolean, replaces?: string, name?: string): ThunkAction<void, State, void, AddMedia | RemoveMedia>;
/**
 * @description
 ...
 * @param name
 */
export declare function addLocalScreen(track: MediaStreamTrack, stream: MediaStream, replaces?: string, name?: string): ThunkAction<void, State, void, AddMedia | RemoveMedia>;
/**
 ...
 * @param name string
 */
export declare function addRemoteMedia(roomAddress: string, peerAddress: string, id: string, track: MediaStreamTrack, stream: MediaStream, screen: boolean, name: string): ThunkAction<void, State, void, AddMedia | RemoveMedia>;
/**
 * @description
 * Remove media.
 *
 ...
 */
export declare function requestQualityProfile(id: string, profile: 'high' | 'medium' | 'low' | 'off'): ThunkAction<void, State, void, RemoveMedia>;
/**
 * @description
