...
exports.setGlobalVolumeLimit = exports.setAudioOutputDevice = exports.setPushToTalk = exports.setVoiceActivityThreshold = exports.setDesiredMedia = exports.setDisplayName = void 0;
...
function setDesiredMedia(mediaKind) {
    return (dispatch, getState) => {
        ...
        const calls = (0, Selectors_1.getJoinedCalls)(state);
        for (const call of calls) {
            dispatch((0, Calls_1.setDesiredMediaForCall)(call.roomAddress, mediaKind));
        }
        if (client) {
            client.sendAllRoomsPresence();
        }
...
function setVoiceActivityThreshold(threshold = -65) {
    (0, Hark_1.setGlobalVoiceActivityThreshold)(threshold);
    return {
        payload: {
