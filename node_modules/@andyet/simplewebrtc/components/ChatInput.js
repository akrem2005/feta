...
exports.ChatInputTextArea = void 0;
 ...
 *
 */
const ChatInputTextArea = props => (React.createElement("textarea", { id: props.id, className: props.className, autoFocus: props.autoFocus, value: props.message, placeholder: props.placeholder, disabled: props.disabled, onInput: event => {
...
exports.ChatInputTextArea = ChatInputTextArea;
/**
 * @description
 *
 * @public
...
class ChatInput extends React.Component {
    ...
    render() {
        ...
        return React.createElement(exports.ChatInputTextArea, { ...renderProps });
    }
}
...
exports.default = (0, react_redux_1.connect)(mapStateToProps, mapDispatchToProps)(ChatInput);
