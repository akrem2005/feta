...
exports.RequestUserMedia = void 0;
...
class RequestUserMedia extends React.Component {
    ...
    async getMedia(additional = {}) {
        ...
        if (audio) {
            ...
            this.props.addLocalAudio(audio, stream, this.props.replaceAudio, volumeMonitoring, this.props.audioName ?? this.props.name);
        ...
        if (video) {
            ...
            if (this.props.screenCapture) {
                this.props.addLocalScreen(video, stream, this.props.replaceVideo, this.props.videoName ?? this.props.name);
            }
            else {
                this.props.addLocalVideo(video, stream, this.props.mirrored, this.props.replaceVideo, this.props.videoName ?? this.props.name);
            }
            if (this.props.share !== false) {
...
function mapStateToProps(state, props) {
    const permissions = (0, Selectors_1.getDevicePermissions)(state);
    return {
        ...props,
...
function mapDispatchToProps(dispatch) {
    return {
        addLocalAudio: (track, stream, replace, volumeMonitoring, name) => dispatch(Actions.addLocalAudio(track, stream, replace, volumeMonitoring, name)),
        addLocalScreen: (track, stream, replace, name) => dispatch(Actions.addLocalScreen(track, stream, replace, name)),
        addLocalVideo: (track, stream, mirrored, replace, name) => dispatch(Actions.addLocalVideo(track, stream, mirrored, replace, name)),
...
exports.default = (0, react_redux_1.connect)(mapStateToProps, mapDispatchToProps)(RequestUserMedia);
