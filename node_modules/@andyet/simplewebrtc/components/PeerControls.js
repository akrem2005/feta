...
function mapStateToProps(state, props) {
    const peer = (0, Selectors_1.getPeerByAddress)(state, props.peer.address) || {};
    return {
...
exports.default = (0, react_redux_1.connect)(mapStateToProps, mapDispatchToProps)(PeerControls);
