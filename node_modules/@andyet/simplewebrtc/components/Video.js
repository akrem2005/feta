...
class Video extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("video", { id: this.props.id, className: this.props.className, ref: (el) => {
                this.video = el;
...
exports.default = (0, react_redux_1.connect)((_, props) => props, mapDispatchToProps)(Video);
