...
function mapStateToProps(state, props) {
    ...
    if (props.roomAddress) {
        room = (0, Selectors_1.getRoomByAddress)(state, props.roomAddress);
    }
    if (!room && props.name) {
        room = (0, Selectors_1.getRoomByProvidedName)(state, props.name);
    }
    const localMedia = !props.excludeMedia ? (0, Selectors_1.getLocalMedia)(state) : undefined;
    const remoteMedia = !props.excludeMedia ? (0, Selectors_1.getRemoteMedia)(state) : undefined;
    const peers = room && !props.excludePeers ? (0, Selectors_1.getPeersForRoom)(state, room?.address) : undefined;
    return {
        call: room ? (0, Selectors_1.getCallForRoom)(state, room.address) : undefined,
        connectionState: (0, Selectors_1.getConnectionState)(state),
        localMedia,
        peers,
        remoteMedia,
        room,
...
exports.default = (0, react_redux_1.connect)(mapStateToProps, mapDispatchToProps)(Room);
