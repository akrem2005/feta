    ...
    render() {
        ...
        return (React.createElement(StayDownContainer_1.default, { id: this.props.id, className: this.props.className }, groups.map(group => {
            if (this.props.renderGroup) {
                ...
                return React.createElement(ChatListGroup, { ...group });
            }
        })));
    }
}
function mapStateToProps(state, props) {
    ...
    return {
        ...props,
        groups: (0, Selectors_1.getGroupedChatsForRoom)(state, props.room, props.maxGroupDuration) || []
    };
}
exports.default = (0, react_redux_1.connect)(mapStateToProps)(ChatList);
